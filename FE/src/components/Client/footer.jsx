...
export const Footer = () => {
  return (
    <footer className="bg-secondary text-white pt-8 pb-[56px] lg:pb-0">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg lg:text-xl font-semibold mb-4">NTDShop</h3>
        ...
        <div className="flex justify-between items-center mt-4 flex-wrap">
          <div className="mt-8">
            ...
            <div>
              <img
                src="https://ttcenter.com.vn/images/payment/methods.svg"
                alt="Payment Methods"
              />
            </div>
          </div>
          ...
          <div className="mt-8 w-60">
            <Link to="http://online.gov.vn/Home/WebDetails/113488">
              <img
                src="https://ttcenter.com.vn/images/logoSaleNoti.png"
                alt="Bộ Công Thương"
            ...
            <ul className="flex space-x-4">
              <li>
                <Link to="" target="_blank">
                  <img
                    src="https://ttcenter.com.vn/images/social/facebook.svg"
                    alt="facebook"
                    className="w-8"
                  />
                </Link>
              ...
              <li>
                <Link to="" target="_blank">
                  <img
                    src="https://ttcenter.com.vn/images/social/tiktok.svg"
                    alt="tiktok"
                    className="w-8"
                  />
                </Link>
              ...
              <li>
                <Link to="" target="_blank">
                  <img
                    src="https://ttcenter.com.vn/images/social/youtube.svg"
                    alt="youtube"
                    className="w-8"
                  />
                </Link>
              ...
              <li>
                <Link to="" target="_blank">
                  <img
                    src="https://ttcenter.com.vn/images/social/zalo.svg"
                    alt="zalo"
                    className="w-8"
                  />
                </Link>
      ...
      <div className="bg-gray-900 py-4 mt-8">
        <p className="container text-sm text-center">
          CÔNG TY TNHH CÔNG NGHỆ TIẾN THẮNG - GPĐKKD: 0402168806 cấp tại Sở KH &
          ĐT TP. Đà Nẵng. Địa chỉ văn phòng: 114 Hàm Nghi, Phường Thạc Gián,
